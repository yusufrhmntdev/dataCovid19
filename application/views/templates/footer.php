 ...
 <!-- Mainly scripts -->    
    ...
    <!-- Flot -->
    <!-- <script src="<?php echo base_url()?>vendor/js/plugins/flot/jquery.flot.js"></script>
    <script src="<?php echo base_url()?>vendor//plugins/flot/jquery.flot.tooltip.min.js"></script>
    <script src="<?php echo base_url()?>vendor/js/plugins/flot/jquery.flot.spline.js"></script>
    <script src="<?php echo base_url()?>vendor/js/plugins/flot/jquery.flot.resize.js"></script>
    <script src="<?php echo base_url()?>vendor/js/plugins/flot/jquery.flot.pie.js"></script>
    <script src="<?php echo base_url()?>vendor/js/plugins/flot/jquery.flot.symbol.js"></script>
    <script src="<?php echo base_url()?>vendor/js/plugins/flot/jquery.flot.time.js"></script> -->
    ...
    <!-- Jvectormap -->
    <!-- <script src="<?php echo base_url()?>vendor/js/plugins/jvectormap/jquery-jvectormap-2.0.2.min.js"></script>
    <script src="<?php echo base_url()?>vendor/js/plugins/jvectormap/jquery-jvectormap-world-mill-en.js"></script> -->

    <!-- EayPIE -->
    <!-- <script src="<?php echo base_url()?>vendor/js/plugins/easypiechart/jquery.easypiechart.js"></script> -->

    <!-- Sparkline -->
    <!-- <script src="<?php echo base_url()?>vendor/js/plugins/sparkline/jquery.sparkline.min.js"></script> -->

    <!-- Sparkline demo data  -->
    <!-- <script src="<?php echo base_url()?>vendor/js/demo/sparkline-demo.js"></script> -->
